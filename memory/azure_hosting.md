...
description: Azure Static Web App resource details and the deferred dzign3d.com custom-domain plan
type: project
---
...
Registrar holding `dzign3d.com` is unconfirmed — ask the user when starting this work.
