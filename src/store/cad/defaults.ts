...
export const REVOLVE_DEFAULTS = {
  ...
  revolveExtentType: 'angle' as 'angle' | 'to-object',
  revolveToEntityFaceCentroid: null as [number, number, number] | null,
  revolveToEntityFaceNormal: null as [number, number, number] | null,
