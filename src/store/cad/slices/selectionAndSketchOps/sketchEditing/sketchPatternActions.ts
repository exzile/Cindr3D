...
export function createSketchPatternActions({ set, get }: CADSliceContext): Partial<CADState> {
  return {
    ...
    commitSketchRectPattern: () => {
      ...
      set({
        ...
        statusMessage: `Rectangular pattern: ${cx}x${cy} (${copies.length} new entities added)`,
      });
    },
