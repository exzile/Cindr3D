  ...
  return (
    <>
      ...
      <RibbonSection title="CONSTRAINTS" menuItems={sketchConstraintMenuItems} accentColor="#ff6b00" maxVisible={maxBigSection}>
        ...
        <ToolButton icon={<GitMerge size={20} />} label="Smooth (G2+)" active={activeTool === 'constrain-smooth'} onClick={() => { setActiveTool('constrain-smooth' as T); setStatusMessage('Smooth: click two curves sharing a point to apply G2 curvature + collinear curvature vectors'); }} colorClass="icon-orange" />
